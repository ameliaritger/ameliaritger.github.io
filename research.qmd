...
Check out my Github repositories for my research-in-progress on strawberry anemones <a href="https://github.com/ameliaritger/Ritger-2019-Corynactis-measurements" target="_blank">here</a> and <a href="https://github.com/ameliaritger/Ritger-2019-Corynactis-urchin-deterrence" target="_blank">here</a>.

# Ocean Acidification

I am using the black turban snail (*Tegula funebralis*) to study the impacts of ocean acidification across species ranges. Turban snails are incredibly abundant in the intertidal zone, and they also are known to respond to acidic conditions with slower growth and weaker shells. 
...
Black turban snails (*Tegula funebralis*) exist across the California Current Large Marine Ecosystem, which extends from Baja California (Mexico) to British Columbia (Canada). Across this broad geographic range, snail populations are exposed to a mosaic of acidic conditions (due to upwelling) as well as different predator communities.

Climate change is predicted to intensify upwelling and shift ecological communities, but there is limited research on how marine populations across the coastline may differ in their response to ocean acidification and altered community structure.

My research using the turban snail explores how snail populations may be responding differently to variable pH conditions and predator communities across their range. This research will reveal how calcifying marine species may vary spatially in their vulnerability and resiliency to ocean acidification, and may inform ecosystem management and conservation strategies in the context of future climate change scenarios.
